...
def build_greeting():
  ...
  <div>
    ...
    <p>
      ...
      설립하여 약 24년간 기계 제조업에 전념한 회사로서, 다양한 최신 산업 특수 유압 실린더 제작 및
...
<p>
  ...
  양산체제를 구축하여, 본격적인 생산판매로 롤스로이스 마린 코리아(주), 현대위아(주) 및 현대로템(주),
  보쉬 렉스로스, 동양하이드텍, 한국철강, (주)협신, 한국기계연구원 등의 국내외 주요 기업 및 연구기관에 납품하여
  국내외 시장에서 많은 호평을 받고 있습니다.
</p>

<p>
  역동적인 대한민국의 산업사회에서, 기계 제조업에 종사한 지 24년이라는 긴 연력을 가진 저희
