...
| 날짜 | 로그 | 내용 |
| --- | --- | --- |
| 260818 | [PH-A-7_log_260818.md](PH-A-7_log_260818.md) | `PH-B-35` 모바일 대응 검수·수정 · 로고를 원본 사이트 것으로 교체 · 화면의 내부 검토 메모 전량 삭제 · Pages 배포 실패 대응 · **(2)** A안 견적서 작성 — 비사업자라 부가세 청구 불가, 원천징수 3.3% 구조로 전환 |
