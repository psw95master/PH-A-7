...
**https://nawoohitech.pages.dev**

> **Cloudflare Pages 로 옮겼습니다** (`260918`). `main` 에 푸시하면 자동 배포됩니다.
> 출력 폴더는 `PH-B-35`, 빌드 명령은 없습니다(정적 HTML).
>
> ⚠️ 아직 **검토용 주소**입니다. 실주소 `nawoohitech.co.kr` 전환은 **가비아 소유자 인증에 막혀 대기 중**입니다.
> 경위와 남은 일은 [`@log/PH-A-7_@log_260918.md`](@log/PH-A-7_@log_260918.md).
>
...
| ~~주소 표기~~ | ✅ `260917` 해결. 정본은 **부산 강서구 화전산단 3로 102** (페리 확인). 사이트에 남은 옛 표기(`송정동`) 정리 필요 |
